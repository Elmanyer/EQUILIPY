...
class Tokamak:
    ...
    def __init__(self,MAGNETS,PROBLEM):
        ...
        self.Nn = len(PROBLEM.MESH.BoundaryVertices)
        self.nodes = PROBLEM.MESH.BoundaryVertices      # FIRST WALL VERTICES NODES (GLOBAL INDEXES)
        self.Xwall = PROBLEM.MESH.X[self.nodes,:]       # FIRST WALL VERTICES COORDINATES MATRIX
        self.wall_path = PROBLEM.MESH.boundary_path     # FIRST WALL PATH (FOR PATCHING)
