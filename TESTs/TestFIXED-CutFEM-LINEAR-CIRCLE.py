...
##### OUTPUT FILES
Equilibrium.out_proparams = False       # OUTPUT SWITCH FOR SIMULATION PARAMETERS 
Equilibrium.out_boundaries = False      # OUTPUT SWITCH FOR BOUNDARIES DATA
Equilibrium.out_elemsClas = False       # OUTPUT SWITCH FOR CLASSIFICATION OF MESH ELEMENTS
Equilibrium.out_plasmaLS = False        # OUTPUT SWITCH FOR PLASMA BOUNDARY LEVEL-SET FIELD VALUES
Equilibrium.out_plasmaBC = False        # OUTPUT SWITCH FOR PLASMA BOUNDARY CONDITION VALUES 
Equilibrium.out_plasmaapprox = False    # OUTPUT SWITCH FOR PLASMA BOUNDARY APPROXIMATION DATA 
...
Equilibrium.zeta = 1.0e4               # GHOST PENALTY PARAMETER 
...
###### LINEAR TRIANGULAR ELEMENT MESH
#MESH = 'TRI03_LINEAR_1.0'
#MESH = 'TRI03_LINEAR_0.5'
#MESH = 'TRI03_LINEAR_0.1'
#MESH = 'TRI03_LINEAR_0.06'
#MESH = 'TRI03_LINEAR_0.02'

#MESH = 'TRI06_LINEAR_1.0'
#MESH = 'TRI06_LINEAR_0.5'
#MESH = 'TRI06_LINEAR_0.1'
MESH = 'TRI06_LINEAR_0.06'
#MESH = 'TRI06_LINEAR_0.02'
...
EqPrint(f"Gradient jump: {diagnostics['ghost_faces']['gradient_jump_max']}")

# Quick summary
Equilibrium.PrintErrorSummary()